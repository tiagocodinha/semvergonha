(function () {
  ...
  var EN = {
    ...
    'intro.p1': 'Sem Vergonha is not just a restaurant. It’s not a nightclub. It’s a place where <em>something happens</em>. Here, dinner naturally evolves into the night. The cocktails lead to the next dish. And the conversation leads to everything else.',
    'intro.p2': 'Born from the spirit of the <strong>“Muro da Pouca Vergonha”</strong> — Nazaré’s most iconic spot — we reinterpret the tradition of gathering in a contemporary context.',
